...
function drawing_background_lines(_context, _const,
    ...
    drawing_line(_context,
        ...
        _center_x + _const.LINE_LENGTH.WIDTH.TOP_RIGHT + _const.LINE_LENGTH.ADDITION.LARGE, _center_y - _const.LINE_LENGTH.HEIGHT.TOP_RIGHT,
        _const.LINE_WIDTH, _line_cap, _color_line)

    drawing_line(_context,
        _center_x + _const.LINE_LENGTH.WIDTH.TOP_RIGHT, _center_y - _const.LINE_LENGTH.HEIGHT.TOP_RIGHT - _const.LINE_LENGTH.ADDITION.LARGE,
        _center_x + _const.LINE_LENGTH.WIDTH.TOP_RIGHT, _center_y + _const.LINE_LENGTH.ADDITION.LARGE,
        _const.LINE_WIDTH, _line_cap, _color_line)
    ...
    drawing_line(_context,
        ...
        _center_x + _const.LINE_LENGTH.WIDTH.BOTTOM_RIGHT, _center_y + _const.LINE_LENGTH.HEIGHT.BOTTOM_RIGHT,
        _const.LINE_WIDTH, _line_cap, _color_line)
